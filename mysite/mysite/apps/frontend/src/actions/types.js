...
export const UPDATE_OBJPOINT = 'UPDATE_OBJPOINT';

export const CREATE_GROUP = 'CREATE_GROUP';
export const DELETE_GROUP = 'DELETE_GROUP';
export const SELECTE_GROUP = 'SELECTE_GROUP';
export const RENAME_GROUP = 'RENAME_GROUP';

export const ADD_ITEM_TO_GROUP = 'ADD_ITEM_TO_GROUP';
export const DEL_ITEM_TO_GROUP = 'DEL_ITEM_TO_GROUP';
export const SORTED_ITEM_TO_GROUP = 'SORTED_ITEM_TO_GROUP';

export const HOVER_OBJECT = 'HOVER_OBJECT';
